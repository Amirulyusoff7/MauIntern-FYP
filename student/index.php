    ...
    <main>
        <div class="index-container">
            <div class="career-tips">
                <div class="card-body">
                    <h1 class="card-title"><a href="../student/careertips.php">Career Tips</a></h1>
                    <h1 class="card-title"><a href="../student/cover-letter.php">Career Development Resources</a></h1>
                ...
                <div class="search-bar">
                    <div class="input-group">
                        ...
                        <div class="input-group-append">
                            <p>Refresh or Click Home to search other Internship</p>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-4">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="card-text"><?php echo $internship['Address']; ?></p>
                                        <p class="card-text"><?php echo $internship['Industry']; ?></p>
                                        <a href="../student/apply-intern.php?internshipID=<?php echo $internship['internshipID']; ?>" class="btn btn-primary">View to Apply</a>
                                    </div>
                                </div>
                            </div>
                        <?php } ?>
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#searchInput').on('input', function() {
                ...
                // Example: Filtering internship cards based on the searchValue
                $('.card').each(function() {
