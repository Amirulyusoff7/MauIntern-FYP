...
<body>
    ...
    <div class="sidebar">
        ...
        <!-- Sidebar links -->
        <a href="/psm/company/dashboard.php">Dashboard</a>
        <a href="/psm/company/intern-application.php">Internship Application</a>
        <a href="/psm/company/company-profile.php">Company Profile</a>
        <a href="/psm/company/intern-list.php">Internship Posting</a>
