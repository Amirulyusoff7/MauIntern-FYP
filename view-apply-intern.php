...
if (isset($_GET['internshipID'])) {
    ...
    if ($internship) {
        ...
        if (!isset($_SESSION['studentID'])) {
            ...
            echo '<button type="button" class="btn btn-primary btn-lg" onclick="redirectToLogin()">Apply</button>';
        } else {
            echo '<form action="../psm/student/apply-process.php" method="POST">';
...
function redirectToLogin() {
    ...
    setTimeout(function() {
        window.location.href = "./student/studentlogin.php";
